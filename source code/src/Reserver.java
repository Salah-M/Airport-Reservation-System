	...
	public Reserver() {
		...
		setContentPane(contentPane);
		 contentPane.setLayout(null);
			...
			comboBox_2.setBounds(110, 94, 33, 24);
               ...
               try { 
				...
				temp+=(((t.charAt(0)-'0')*10+t.charAt(1)-'0')%12)/2;
			     ...
			     if(reply.equals("success")){
			    	 JOptionPane.showMessageDialog(null, "Reservation Succeeded!");
			    	 return ;
			     }
			     else if(reply.equals("bookedYou")) {
			    	 JOptionPane.showMessageDialog(null, "You already booked this time slot!");
			     }
			     else if(reply.equals("bookedOthers")) {
			    	 JOptionPane.showMessageDialog(null, "This time slot is not free!");
			     }
		...
		URL resource;
		ImageIcon body;
		 resource = getClass().getClassLoader().getResource( "11.png" );
		...
		JLabel lblNewLabel_2 = new JLabel("Reserver");
